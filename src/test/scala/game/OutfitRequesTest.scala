...
class OutfitRequestTest extends Specification {
  val string0 =
    hex""
  ...
  "encode 0" in {
    val msg = OutfitRequest(
      41593365L,
      OutfitRequestForm.Unk0(
  ...
  "encode 1" in {
    val msg = OutfitRequest(
      41593365L,
      OutfitRequestForm.Unk1(List(Some(""), Some(""), Some(""), Some(""), Some(""), Some(""), Some(""), Some("")))
    )
    val pkt = PacketCoding.encodePacket(msg).require.toByteVector
