...
import net.psforever.types.StatisticalElement.{
  AMS,
  ANT,
  AgileExoSuit,
  ApcNc,
  ...
  PeregrineGunner,
  PhalanxTurret,
  PortableMannedTurretNc,
  PortableMannedTurretTr,
  PortableMannedTurretVs,
  Prowler,
  QuadAssault,
  QuadStealth,
  Raider,
...
object StatisticalCategory extends IntEnum[StatisticalCategory] {
  ...
  final case object ReviveAssist
      extends StatisticalCategory(value = 4) //number of allies who killed enemies after being revived
  ...
  final case object ReviveKillAssist
      extends StatisticalCategory(value = 21) //number of enemies killed by allies you have revived
  final case object RepairKillAssist
      extends StatisticalCategory(value = 22) //number of enemies killed by allies you have repaired
  ...
  val statElements: Seq[Seq[StatisticalElement]] = {
    ...
    Seq(
      ...
      Seq(
        ...
        XmasGingermanHvar,
        XmasGingermanIzha,
        XmasGingermanJamshid,
        XmasGingermanMithra,
        XmasGingermanRashnu,
        XmasGingermanSraosha,
        XmasGingermanYazata,
        XmasGingermanZal,
        XmasSled1,
        XmasSled2,
