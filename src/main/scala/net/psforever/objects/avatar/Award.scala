...
object AwardCategory extends Enumeration {
  val Activity, Defense, Exclusive, Support, Vehicular, Weaponry = Value
}
...
object Award extends StringEnum[Award] {
  ...
  case object AdvancedMedicAssists
      extends Award(
  ...
  case object DefenseVS
      extends VanuSovereigntyAward(
        value = "DefenseVS",
        AwardCategory.Defense,
        List(
...
//  )
  ...
  case object RouterTelepadDeploy
      extends Award(
  ...
  case object StracticsHistorian
      extends Award(
  ...
  case object TransportationCitation
      extends Award(
