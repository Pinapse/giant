...
/**
  ...
  * @param info na
  */
final case class OutfitRequest(id: Long, info: OutfitRequestForm) extends PlanetSideGamePacket {
...
object OutfitRequest extends Marshallable[OutfitRequest] {
  ...
  /**
    * na
    */
  private val unk0Codec: Codec[OutfitRequestForm] = PacketHelpers
    .encodedWideStringAligned(adjustment = 5)
    .hlist
  ...
  /**
    * na
    */
  private def failCodec(code: Int): Codec[OutfitRequestForm] =
    conditional(included = false, bool).exmap[OutfitRequestForm](
