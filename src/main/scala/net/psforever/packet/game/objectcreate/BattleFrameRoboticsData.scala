    ...
    (
      ("pos" | PlacementData.codec) >>:~ { pos =>
        ("data" | CommonFieldData.codec(extra = false)) ::
          ...
          optional(
            bool,
            target =
              "inventory" | MountableInventory.custom_inventory_codec(pos.vel.isDefined, VehicleFormat.Battleframe)
          )
      }
      ...
      },
      {
        case BattleFrameRoboticsData(
          ...
          Attempt.successful(
            pos :: data :: health :: shield :: 0 :: u2 :: no_mount :: drive :: proper_anim :: u3 :: show_bfr_shield :: inv :: HNil
          )
    ...
    (
      ("pos" | PlacementData.codec) >>:~ { pos =>
        ("data" | CommonFieldData.codec(extra = false)) ::
          ...
          optional(
            bool,
            target = "inventory" | MountableInventory.custom_inventory_codec(
              pos.vel.isDefined,
              VehicleFormat.BattleframeFlight
            )
          )
      }
    ).exmap[BattleFrameRoboticsData](
      ...
      },
      {
        case BattleFrameRoboticsData(
          ...
          Attempt.successful(
            pos :: data :: health :: shield :: 0 :: u2 :: no_mount :: drive :: proper_anim :: u3 :: show_bfr_shield :: unk4 :: inv :: HNil
          )
