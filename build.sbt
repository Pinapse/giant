...
lazy val psforeverSettings = Seq(
  ...
  libraryDependencies ++= Seq(
    ...
    "com.typesafe.akka"          %% "akka-protobuf-v3"         % "2.8.2",
    "com.typesafe.akka"          %% "akka-stream"              % "2.8.2",
    "com.typesafe.akka"          %% "akka-testkit"             % "2.8.2"  % "test",
    "com.typesafe.akka"          %% "akka-actor-typed"         % "2.8.2",
    "com.typesafe.akka"          %% "akka-actor-testkit-typed" % "2.8.2"  % "test",
    "com.typesafe.akka"          %% "akka-slf4j"               % "2.8.2",
    "com.typesafe.akka"          %% "akka-cluster-typed"       % "2.8.2",
    "com.typesafe.akka"          %% "akka-coordination"        % "2.8.2",
    "com.typesafe.akka"          %% "akka-cluster-tools"       % "2.8.2",
    ...
    // "io.kamon"                   %% "kamon-bundle"               % "2.6.3",
    // "io.kamon"                   %% "kamon-apm-reporter"         % "2.6.3",
